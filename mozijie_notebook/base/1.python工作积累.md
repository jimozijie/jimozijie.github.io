...
2. 提交到本地仓库
   ...
   <img src="python工作积累.assets/image-20241031091900039.png" alt="image-20241031091900039" style="zoom: 80%;" />
...
3. 推送到Gitee远程仓库
   ...
   <img alt="image-20241031092102695" src="python工作积累.assets/image-20241031092102695.png"/>

   点击推送

   第一次提交要定义远程仓库

   <img alt="image-20241031092209575" src="python工作积累.assets/image-20241031092209575.png"/>

   名称建议和远程仓库名字一样+Gitee

   URL等于你创建仓库的地址，如下图

   <img src="python工作积累.assets/image-20241031092305262.png" alt="image-20241031092305262" style="zoom: 67%;" />

   这里使用SSH进行推送

   <img src="python工作积累.assets/image-20241031092349838.png" alt="image-20241031092349838" style="zoom:80%;" />
...
<img src="python工作积累.assets/2025-01-16-10-04-59-image.png" title="" alt="" width="270">
