...
https://blog.csdn.net/qq_32892383/article/details/116137730
...
1. 进入安装了YOLO的conda环境【建议python<=3.9,太新的环境会不兼容】
...
使用LabelImg标注YOLO目标检测数据格式——LabelImg详细使用教程
见如下网址：
https://blog.csdn.net/JH_joker/article/details/140489088

### 4.2.自动标注工具X-AnyLabeling的使用

教程参考下列网址：
https://blog.csdn.net/m0_58389434/article/details/134380444
个人认为比LabelImg好用

### 4.3.YOLO格式txt数据增强，水平/垂直翻转、明亮度、饱和度、高斯、椒盐噪声等

参考地址：
https://blog.csdn.net/weixin_43752269/article/details/143719488
